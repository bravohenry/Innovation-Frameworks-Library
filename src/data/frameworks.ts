...
const seededFrameworks: Framework[] = [
  ...
  { title: '团队协作的五大障碍', englishTitle: 'The Five Dysfunctions of a Team', slug: 'five-dysfunctions-team', chapter: '1', subsectionId: '1.1', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/five-dysfunctions-team.pptx' },
  { title: 'RACI 责任分配矩阵', englishTitle: 'RACI Chart', slug: 'raci-chart', chapter: '1', subsectionId: '1.1', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/raci-chart.pptx' },
  { title: '甘特图', englishTitle: 'Gantt Chart', slug: 'gantt-chart', chapter: '1', subsectionId: '1.1', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/gantt-chart.pptx' },
  { title: 'PESTLE 分析', englishTitle: 'PESTLE Analysis', slug: 'pestle-analysis', chapter: '1', subsectionId: '1.2', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/pestle-analysis.pptx' },
  { title: '波特五力模型', englishTitle: "Porter's Five Forces", slug: 'porters-five-forces', chapter: '1', subsectionId: '1.2', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/porters-five-forces.pptx' },
  { title: 'SWOT 分析', englishTitle: 'SWOT Analysis', slug: 'swot-analysis', chapter: '1', subsectionId: '1.2', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/swot-analysis.pptx' },
  { title: 'sSWOT 分析', englishTitle: 'sSWOT Analysis', slug: 'sswot-analysis', chapter: '1', subsectionId: '1.2', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/sswot-analysis.pptx' },
  { title: '商业机会声明', englishTitle: 'Business Opportunity Statement', slug: 'business-opportunity-statement', chapter: '1', subsectionId: '1.3', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/business-opportunity-statement.pptx' },
  { title: '谷歌“北极星”框架', englishTitle: 'The North Star Framework', slug: 'north-star-framework', chapter: '1', subsectionId: '1.3', chapterTitle: '发现与战略基础', chapterTitleEn: 'Discovery & Strategy', tags: [], summary: '', templateUrl: '/templates/north-star-framework.pptx' },
